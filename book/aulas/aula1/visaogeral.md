...
[^1]: Dados rotulados são aqueles em que cada exemplo no conjunto de dados possui uma resposta ou rótulo associado, fornecendo a base para o treinamento de modelos supervisionados.
